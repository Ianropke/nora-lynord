...
const createWorlds = (names: WorldName[], words: string[], startId: number): World[] => {
...
const unovaWords = ["eventyr","rejse","opdagelse","gåte","skovsti","bjergtop","flod","dal","landsby","bytorv","marked","bro","fyrtårn","kyst","ø","hule","ruin","slot","tårn","eje","galakse","måne","solopgang","solnedgang","skygge","lysstråle","regndråbe","vandfald","bål","lejrbål","rygsæk","kompas","kort","kikkert","lommelygte","sovepose","telt","vandflaske","frokost","snor","nøgle","blyant","kridt","lineal","saks","lim","maling","pensel","palet","kasse","kuffert","pakke","brev","besked","telefon","kamera","billede","film","musik","tromme","guitar","klaver","melodi","rytme","danser","scene","publikum","koncert","grine","smile","råbe","hviske","lytte","spørge","svare","forklare","fortælle","beskrive","bygge","skabe","opfinde","reparere","sortere","samle","bytte","assistere","samarbejde","aftale","regel","plan","mål","drøm","mod","styrke","øvelse","træning","forsøg","resultat","løsning","fejltagelse","læring","belønning","fremskridt","ansvar","beslutning","overraskelse","fantasi","videbegærlig","modig","venlig","kreativ","rolig","årvågen","stærk","stille","hurtigere","dygtig","tilfreds","klar","fælles"];
...
const kalosWords = ["fordybelse","sammenligning","argument","bevis","årsag","virkning","eksempel","sammenhæng","forskel","lighed","mønster","rækkefølge","retfærdighed","ansvarlig","beskrivelse","fortolkning","spørgsmål","svarmulighed","afgørelse","begrundelse","opfindelse","opdagelsesrejsende","laboratorium","eksperiment","forstørrelsesglas","mikroskop","magnet","måling","temperatur","vægt","afstand","hastighed","kurs","vinkel","form","cirkel","trekant","firkant","kube","mønsterbrik","jordklode","kontinent","hovedstad","grænse","beboer","kultur","sprog","tradition","festival","museum","teater","udstilling","forfatter","illustration","kapitel","sætning","punktum","komma","overskrift","ordbog","moral","venlighed","ærlighed","videbegær","tillid","respekt","holdarbejde","samhørighed","fortryde","tilgive","forsvare","beskytte","opmuntre","foreslå","forhandle","diskutere","enige","uenige","vælge","prioritere","planlægge","forberede","gennemføre","fortsætte","forandre","forbedre","undersøge","opdage","udvikle","vurdere","muligt","umuligt","sandsynlig","sjælden","almindelig","uundværlig","risikabel","sikker","varsom","præcis","udholdenhed","fokus","forestillingsevne","ærgrelse","begejstring","bekymring","lettelse","selvtillid","fund","håb","magisk","glimrende","besværlig","uventet","særlig","nøjagtig","effektiv","moderne","enorm","betydningsfuld"];
